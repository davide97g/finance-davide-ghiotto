import { CalendarDays, Euro, FileText, FolderOpen, Tag as TagIcon } from "lucide-react";
...
export default function NewTransactionPopup({ open, onOpenChange, type }: Props) {
  ...
  const isDisabled = !transaction.amount || !transaction.date || !transaction.category;
