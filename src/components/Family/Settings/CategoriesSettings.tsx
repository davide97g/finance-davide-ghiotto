...
export default function CategoriesSettings() {
	...
	const [updateCategoryPopupVisible, setUpdateCategoryPopupVisible] =
		useState(false);
	...
	return (
		<div className="text-left">
			...
			<NewCategoryPopup
				open={newCategoryPopupVisible}
				onOpenChange={setNewCategoryPopupVisible}
			/>
			<Separator className="my-4" />
			{selectedCategory && (
				<UpdateCategoryPopup
					open={updateCategoryPopupVisible}
					onOpenChange={setUpdateCategoryPopupVisible}
