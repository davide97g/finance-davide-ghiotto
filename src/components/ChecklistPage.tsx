...
export default function ChecklistPage({
	...
	return (
		<div className="h-screen flex flex-col">
			{/* Sticky header + input */}
			<div className="shrink-0 sticky top-0 z-10 bg-[#eaefea]">
				{/* Header */}
				...
				<div className="px-5 pb-4">
					<div className="flex items-center gap-2 bg-white/70 backdrop-blur-sm rounded-xl px-3 py-1.5 shadow-sm border border-black/[0.04]">
						{filterWhileTyping ? (
