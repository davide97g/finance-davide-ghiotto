...
export default function ChecklistPage({
  ...
  const pending = useMemo(() => {
    ...
    if (filterWhileTyping && newItem) {
      filtered = filtered.filter((i) => i.label.toLowerCase().includes(newItem.toLowerCase()));
    }
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="shrink-0 sticky top-0 z-10 bg-background transition-all duration-300">
        ...
        >
          ...
          >
            ...
            <div className="relative shrink-0 ml-8">
              <svg width={32} height={32} className="transform -rotate-90" aria-hidden="true">
                <circle
                  cx={16}
                  cy={16}
                  r={12}
        ...
        {/* Search/Add input */}
        <div className={cn("px-5 transition-all duration-300", isCompact ? "pb-2.5" : "pb-4")}>
          <div
            className={cn(
