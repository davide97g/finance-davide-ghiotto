...
const navItems = [
  {
    ...
    iconBg: "bg-emerald-600/10 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400",
  },
  {
    to: "/groceries",
    icon: List,
    ...
    iconBg: "bg-amber-600/10 text-amber-700 dark:bg-amber-500/15 dark:text-amber-400",
  },
  {
    to: "/todo",
    icon: CheckSquare,
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center px-6 pt-16 pb-10">
        {/* Avatar area */}
        {isLoggedIn && (
          <Link to="/profile" className="group mb-8 animate-[fadeSlideIn_0.5s_ease_both]">
        ...
        {isLoggedIn !== undefined ? (
          !isLoggedIn ? (
            <Link to="/login" className="animate-[fadeSlideIn_0.5s_0.2s_ease_both]">
              <button
                type="button"
